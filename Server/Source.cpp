	...
	boost::shared_ptr<boost::asio::ip::tcp::acceptor>& paccept)
{
	...
	std::cout << pSocket->local_endpoint().address().to_string() << std::endl;
	std::cout << pSocket->local_endpoint().port() << std::endl;
	std::cout << pSocket->remote_endpoint().address().to_string() << std::endl;
	std::cout << pSocket->remote_endpoint().port() << std::endl;
